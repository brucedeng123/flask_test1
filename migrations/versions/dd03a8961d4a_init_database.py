...
Revision ID: dd03a8961d4a
Revises: 
Create Date: 2021-03-13 11:25:29.552023
...
def upgrade():
    ...
    op.drop_table('myclass')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('myclass',
    sa.Column('id', mysql.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', mysql.CHAR(length=20), nullable=False),
    sa.Column('sex', mysql.INTEGER(), server_default=sa.text("'0'"), autoincrement=False, nullable=False),
    sa.Column('degree', mysql.DOUBLE(precision=16, scale=2, asdecimal=True), nullable=True),
    sa.PrimaryKeyConstraint('id'),
